...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills with drills and friendly games",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["maria@mergington.edu", "jordan@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        "description": "Practice acting, stage design, and perform short plays",
    ...
    "Debate Team": {
        "description": "Prepare for debates and learn persuasive speaking skills",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
